                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="dashboard/assets/images/{{Auth::user()->avartar  ?? '_default-user.png'}}"
                                                alt="">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <a href="./admin/logout" class="btn-pill btn-shawdow btn-shine btn btn-focus">
                                                                        Logout
                                                                    </a>
