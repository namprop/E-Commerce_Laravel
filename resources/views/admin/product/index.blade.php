                    ...
                    <div class="card-header">
                        ...
                        <form method="GET">
                            <div class="input-group">
                                <input type="search" name="search" id="search" value="{{request('search')}}"  placeholder="Search everything"
                                    class="form-control">
                                                ...
                                                <div class="widget-content-left mr-3">
                                                    <div class="widget-content-left">
                                                        <img style="height: 60px;" data-toggle="tooltip" title="Image"
                                                            data-placement="bottom" src="./front/img/products/{{$product->productImages[0]->path ?? 'product-2.jpg'}} "
                                                            alt="">
                                                    </div>                                   
                                                </div>
