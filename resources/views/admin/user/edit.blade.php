                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <img style="height: 200px; cursor: pointer;" class="thumbnail rounded-circle"
                                        ...
                                        src="{{asset('dashboard/assets/images/_default-user.png' )}}" alt="Avatar">

                                    <input name="image" type="file" onchange="changeImg(this)"
                                        class="image form-control-file" style="display: none;" value="{{$user->image}}">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="postcode_zip" id="postcode_zip" placeholder="Postcode Zip"
                                        type="text" class="form-control" value="{{$user->postcode}}">
                                </div>
                            </div>
